...
if (R.home() != "/scratch/users/aqwang/conda/envs/r_package/lib/R") {
  system("/scratch/users/aqwang/conda/envs/r_package/bin/Rscript unilasso_22data_loop_coef.R")
  quit("no")
}
...
# Output dirs
coef_csv_dir <- "coef_csv_22datasets"
...
for (i in seq_along(dataset_names)) {
  ...
  y <- as.numeric(unlist(read.csv(y_path)))
...
save(all_datasets_coefficients, file = "unilasso_22datasets_coefficients_only.RData")
...
cat("RData saved to:", normalizePath("unilasso_22datasets_coefficients_only.RData"), "\n")
...
cat('load("unilasso_22datasets_coefficients_only.RData")\n')
