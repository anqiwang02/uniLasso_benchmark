# This helper builds a side-by-side table of (a) each feature’s univariate coefficient and (b) its selected coefficient from a CV-fit (uniLasso or glmnet), and flags if the signs disagree.
