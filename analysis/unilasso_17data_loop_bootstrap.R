...
filename <- "unilasso_17datasets_100bootstrap_train50percent_all_results_parallel_new.csv"
...
write.csv(all_prediction_intervals, "unilasso_17datasets_100bootstrap_prediction_intervals_new.csv", row.names = FALSE)
cat("Prediction interval results saved to: unilasso_17datasets_100bootstrap_prediction_intervals_new.csv\n")
