# still need to update below with customized lambda grid 
...
if (R.home() != "/scratch/users/aqwang/conda/envs/r_package/lib/R") {
  system("/scratch/users/aqwang/conda/envs/r_package/bin/Rscript unilasso_12data_cuslambda_bootstrap.R")
  quit("no")
}
...
filename <- "unilasso_12datasets_100bootstrap_ownlambda_train50percent.csv"
...
write.csv(all_prediction_intervals, "unilasso_12datasets_100bootstrap_ownlambda_prediction_intervals.csv", row.names = FALSE)
cat("Prediction interval results saved to: unilasso_12datasets_100bootstrap_ownlambda_prediction_intervals.csv\n")
