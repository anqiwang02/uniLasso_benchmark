...
if (R.home() != "/scratch/users/aqwang/conda/envs/r_package/lib/R") {
  system("/scratch/users/aqwang/conda/envs/r_package/bin/Rscript -e 'rmarkdown::render(\"unilasso_12data_loop_basic.Rmd\")'")
  quit("no")
}
...
```{r load results}
# read csv file
results_all_splits <- read.csv("/accounts/grad/aqwang/unilasso/analysis/random_split_result/unilasso_12datasets_100splits_train50percent_ownlambda.csv")
...
ggsave("/accounts/grad/aqwang/unilasso/figures/mse_dist_12data2.png", plot = p_mse, width = 16, height = 17, dpi = 300)
...
ggsave("/accounts/grad/aqwang/unilasso/figures/supp_dist_12data2.png", plot = p_support, width = 16, height = 17, dpi = 300)
...
if (R.home() != "/scratch/users/aqwang/conda/envs/r_package/lib/R") {
  system("/scratch/users/aqwang/conda/envs/r_package/bin/Rscript -e 'rmarkdown::render(\"unilasso_12data_loop_graphs_ownlambda.Rmd\")'")
  quit("no")
}
...
# Get all CSV files in the coef_csv directory
coef_csv_dir <- "/accounts/grad/aqwang/unilasso/analysis/coef_csv_12datasets_ownlambda"
csv_files <- list.files(coef_csv_dir, pattern = "coefficients_.*\\.csv$", full.names = TRUE)
...
ggsave("/accounts/grad/aqwang/unilasso/figures/figures_update/p_mse_supp_sign_stability_12data1.png", 
...
ggsave("/accounts/grad/aqwang/unilasso/figures/figures_update/p_mse_supp_sign_stability_12data2.png", 
...
# updated bootstrap results with uniReg for 22 datasets 9/16 Tuesday
```{r load updated bootstrap results and make some plots}
...
######################################
X <- read.csv("/accounts/grad/aqwang/unilasso/datasets_12/diamond/X.csv")
y<-read.csv("/accounts/grad/aqwang/unilasso/datasets_12/diamond/y.csv")
