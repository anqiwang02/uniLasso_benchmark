# Loop to run uniLasso analysis on all 17 datasets with 100 random splits (PARALLELIZED)
if (R.home() != "/scratch/users/aqwang/conda/envs/r_package/lib/R") {
  system("/scratch/users/aqwang/conda/envs/r_package/bin/Rscript unilasso_17data_loop_basic.R")
  quit("no")
}
...
filename <- paste0("unilasso_17datasets_100splits_train", training_ratio, "_update2_results.csv")
