...
all_interval_widths <- list()  # New list to store individual interval widths
...
for (i in seq_along(dataset_names)) {
  ...
  # Modify the compute_intervals function to also return individual widths
...
# Compute intervals for all methods with individual widths
...
# Store individual widths for this dataset
...
# Save individual interval widths
save(all_interval_widths, file = "unilasso_12data_100bootstrap_interval_widths.RData")
cat("Individual interval widths saved to: unilasso_12data_100bootstrap_interval_widths.RData\n")

# Alternative using saveRDS:
# saveRDS(all_interval_widths, "unilasso_12data_100bootstrap_interval_widths.rds")
# cat("Individual interval widths saved to: unilasso_12data_100bootstrap_interval_widths.rds\n")